...
public class InsertIntoStarSchema {
    public static void main(String[] args) {
        ...
        String enrichedCsvFile = "enriched_transactions.csv";
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPassword)) {
            ...
            String insertCustomerSQL = "INSERT IGNORE INTO customer (customer_id, customer_name) VALUES (?, ?)";
            ...
            String insertDateSQL = "INSERT IGNORE INTO date (time_id, t_date, weekend, half_of_year, month, quarter, year) VALUES (?, ?, ?, ?, ?, ?, ?)";
            String insertSalesSQL = "INSERT IGNORE INTO sales (transaction_id, product_id, customer_id, supplier_id, store_id, time_id, quantity, total_sale) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
